...
interface HealthUnitRepository : MongoRepository<HealthUnit, String> {
    ...
    fun findBySearchTermAndLocationType(
        searchTerm: String,
    ...
    fun aggregateStockAvailable(
        searchTerm: String,
        classificationRegex: String,
        pageable: Pageable
    ): List<MedicineTotalStock>
    ...
    fun aggregateStockAll(searchTerm: String, classificationRegex: String, pageable: Pageable): List<MedicineTotalStock>
